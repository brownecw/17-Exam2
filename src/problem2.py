...
class Triangle(object):
    ...
    def __init__(self, a, b, c):
        ...
        self.largest_area_so_far = self.area()
    ...
    def area(self):
        ...
        S = 0.5 * (length_AB + length_BC + length_CA)

        return round(math.sqrt(S * (S - length_AB) * (S - length_BC) * (S - length_CA)), 6)
    ...
    def get_largest_area(self):
        ...
        return self.largest_area_so_far
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(100, 160)
    expected_b = Point(10, 20)
    expected_c = Point(60, 180)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
